namespace MVC_Uygulama1.Models
{
    using System;
    ...
    {
        // Heryerden bu modeli kullanmamýzý saðlamaktadýr.Diðer türlü her controllerda bu iþlemi yapacaktýk
        public static NorthwindModel Model = new NorthwindModel();
        public NorthwindModel()
            : base("name=NorthwindModelConnection")
        {
        }
