...
namespace ButikOtelRezervasyonu1
{
    ...
    {
        /*
         -Her rezervasyondan sonra oda temizlik için bir gün boþ býrakýlacak
         ve rezervasyon durumu array'inde 2 ile iþaretlenecek. (0-Boþ, 1-Dolu, 2-Temizlik var)
         -Ýki tarih aralýðýnda rezarvasyon yapýlan program parçasýnda bu yeni özelliði yapmayý unutun.
         -Bugünkü boþ odalar sargusunda temizlik yapilan odalari yanlislikla bos gostersin.
