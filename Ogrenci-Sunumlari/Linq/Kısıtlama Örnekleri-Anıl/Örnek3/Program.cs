...
namespace Örnek3
{
    class Program
    {
        ...
        private static List<Kayit> OgrencileriGetir()
        {
            ...
            //Ogrenci not ortalaması 50'e eşit ve büyük olan ogrencilerin yaşını gösterdik.
            foreach (var Ogrenci in Ogrenciler)
            {
                Ogrenci.Ortalama = Ogrenci.Notlar.Average();
                Ogrenci.Basarili = Ogrenci.Ortalama >= 50;
        ...
        {
            //ogrencigetir() metodunun içerisindeki verileri ogrencilere atadık.
            var Ogrenciler = OgrencileriGetir();
            //Bu sorguda başarılı olup 1. sınıfa giden ogrencileri seçtik.
