...
namespace FirmaKayit.Hangar
{
    ...
    partial void OnFdepertmanChanging(string value);
    partial void OnFdepertmanChanged();
    ...
    partial void OnupdateDateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Fadi", DbType="NChar(250)")]
		public string Fadi
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Fdepertman", DbType="NVarChar(50)")]
		public string Fdepertman
		{
			get
			{
				return this._Fdepertman;
			}
			set
			{
				if ((this._Fdepertman != value))
				{
					this.OnFdepertmanChanging(value);
					this.SendPropertyChanging();
					this._Fdepertman = value;
					this.SendPropertyChanged("Fdepertman");
					this.OnFdepertmanChanged();
				}
			}
		}
